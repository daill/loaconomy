...
type Repository interface {
	...
	GetItemPrices(term, server string, from, size, bonusAttack, bonusAccuracy, bonusDefense int, ctx context.Context) ([]byte, error)
...
type UseCase interface {
	...
	AddItemPriceData(item *Item, ctx context.Context) error
	GetItemPrices(term, server string, from, size, bonusAttack, bonusAccuracy, bonusDefense int, ctx context.Context) (string, error)
	TestItemExists(term string, ctx context.Context) (bool, error)
}
